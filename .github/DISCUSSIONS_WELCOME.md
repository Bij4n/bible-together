...
- **Got a question?** Post in **Q&A** — setup help, "how do I run this for my
  small group?", "how do I add a translation?", anything with an answer.
  Resolved threads stay findable for the next person.

- **Have a feature idea?** Post in **Ideas** before building — there's usually
  context behind why something isn't done yet, and a discussion is cheaper than
  building the wrong thing.

- **Want to introduce yourself?** Post here in **General**. We'd love to know
...
**Both English (KJV) and Spanish (RV1909) are first-class.** The UI is bilingual
and every PR that touches user-facing copy ships with both locales updated.
...
README covers setup. If you want to run it for your church, small group, or
community and hit a wall, ask in Q&A.
