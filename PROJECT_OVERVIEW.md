...
`copy_controller.js` (clipboard copy on /donate), `theme_controller.js` (light/dark with server-rendered first paint), `nav_select_controller.js` (custom listbox), `note_panel_controller.js`, `highlight_controller.js`, `comment_controller.js`, `upvote_controller.js`, `flag_controller.js`, `preference_form_controller.js`, `user_menu_controller.js`.
